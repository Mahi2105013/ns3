...
main(int argc, char* argv[])
{
    ...
    Config::SetDefault("ns3::TcpL4Protocol::SocketType", StringValue("ns3::TcpCerl")); // Use TCP CERL


    // Config::SetDefault("ns3::TcpL4Protocol::RecoveryType",
    //     TypeIdValue(TypeId::LookupByName("ns3::TcpClassicRecovery")));
    
    // use tcp cerl recovery:
    Config::SetDefault("ns3::TcpL4Protocol::RecoveryType",
        TypeIdValue(TypeId::LookupByName("ns3::TcpCerlRecovery")));
